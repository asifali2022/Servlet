...
public class AttributeDataApp extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		context.setAttribute("name", "Asif");
		context.setAttribute("Addresse", "kolkata");
		out.println("<html><head><title>Attribute Data Table</title></head>");
		out.println("<body>");
		out.println("<center>");
		out.println("<h1 style='color:blue;'>Dynamic Information in Application Scope</h1>");
