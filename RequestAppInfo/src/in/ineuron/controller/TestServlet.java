...
//  http://localhost:9999/RequestAppInfo/test/Ineuron/asif/tv?name=sachin&password=tendulkar
//  Request URI ::/RequestAppInfo/test/Ineuron/asif/tv
//  Context Path ::/RequestAppInfo
//  Servlet Path::/test/Ineuron
//  Path Info::/asif/tv
//  Query String::name=sachin&password=tendulkar
//  IP Addresse::0:0:0:0:0:0:0:1
...
public class TestServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>IP Addresse::"+request.getRemoteAddr()+"</h1>");
